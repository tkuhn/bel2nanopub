...
scripts/exec-class.sh org.nanopub.extra.server.GetNanopub -c -o output/downloaded.corpora-1.0.nanopubs.trig RACy0I4f_wr62Ol7BhnD5EkJU6Glf-wp0oPbDbyve7P6o
...
scripts/exec-class.sh org.nanopub.extra.server.GetNanopub -c -o output/downloaded.corpora-20131211.nanopubs.trig RAR5dwELYLKGSfrOclnWhjOj-2nGZN_8BW1JjxwFZINHw
