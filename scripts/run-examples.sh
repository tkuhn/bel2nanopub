...
scripts/Bel2Nanopub.sh -c $ORCID -t $TIMESTAMP -u $NS/full_abstract1.bel src/main/resources/examples/pubmed9202001.bel > src/main/resources/examples/pubmed9202001.out.txt
scripts/Bel2Nanopub.sh -c $ORCID -t $TIMESTAMP -u $NS/full_abstract2.bel src/main/resources/examples/pubmed14734561.bel > src/main/resources/examples/pubmed14734561.out.txt
scripts/Bel2Nanopub.sh -c $ORCID -t $TIMESTAMP -u $NS/full_abstract3.bel src/main/resources/examples/pubmed16679305.bel > src/main/resources/examples/pubmed16679305.out.txt
